...
console.log(printTenAnimals(animals));
...
console.log(printAnimalsTwice(animals));
...
console.log(printAnimalPairs(animals));
...
console.log(getAnimalPairs(animals));
...
console.log(getAnimalTriples(animals));
...
console.log(findAnimal(animals, 'bonobo'));
